...
public class TelaEdicaoCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Edição de Cliente");
    ...
    private void botaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoSalvarActionPerformed
        ...
        Boolean retorno = new ClienteController().atualizarCliente(this.idCliente, nome, sobrenome, cpf, email, telefone, endereco);
        
        if (retorno) {
            TelaInicial.telaClientes.atualizarListagem();
            JOptionPane.showMessageDialog(this, "Cliente atualizado com sucesso!");
            TelaClientes.telaEdicaoCliente.setVisible(false);
    ...
    public void carregarDados(Integer id, String nome, String sobrenome, String cpf, String email, String telefone, String endereco) {
        this.idCliente = id;
        
        campoNomeCliente.setText(nome);
        campoSobrenomeCliente.setText(sobrenome);
        campoCpfCliente.setText(cpf);
        campoEmailCliente.setText(email);
        campoTelefoneCliente.setText(telefone);
        campoEnderecoCliente.setText(endereco);
    }
